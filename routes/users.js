...
router.post('/users/add-task/:id', controllers.addToList)
router.put('/users/remove-task/:id', controllers.removeFromList)
router.delete('/users/clear-list/:id', controllers.clearList)
